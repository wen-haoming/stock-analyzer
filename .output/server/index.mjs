...
const _iHFfJyK7MvThXYLeFdXOsk9boiHnArM9w8g94rR9zUc = defineNitroPlugin((nitro) => {
...
const plugins = [
  _iHFfJyK7MvThXYLeFdXOsk9boiHnArM9w8g94rR9zUc
];
...
const assets = {
  "/favicon.svg": {
    ...
    "mtime": "2026-03-18T16:18:42.924Z",
    "size": 9522,
...
const _f1es69 = eventHandler((event) => {
...
const handlers = [
  { route: '', handler: _f1es69, lazy: false, middleware: true, method: undefined }
];
